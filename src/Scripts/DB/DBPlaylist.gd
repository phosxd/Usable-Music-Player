## Database item for music playlists.
...
## Cover image path. Call [param get_cover] to get a usable texture.
var cover_path: String
## Cached color palette for the cover image.
